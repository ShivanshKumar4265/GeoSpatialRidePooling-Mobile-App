          ...
          children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            style: TextStyle(fontSize: screenWidth > 360 ? 15 : 13),
                        ...
                        Icon(Icons.gps_fixed_outlined, color: Colors.grey.shade600, size: 18),
                      ],
                    ),
                  ),
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () {},
                          icon: const Icon(Icons.directions_car, color: Colors.white, size: 16),
                          label: CustomText(
                            text: 'Offer Ride',
                            color: Colors.white,
                      ...
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () {},
                          icon: Icon(Icons.accessibility_new, color: Colors.grey.shade800, size: 16),
                          label: CustomText(
                            text: 'Find Ride',
            ...
            Expanded(
              child: SingleChildScrollView(
                padding: EdgeInsets.fromLTRB(horizontalPadding, 24.0, horizontalPadding, 16.0),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const CustomText(text: 'Your Impact', fontSize: 18, fontWeight: FontWeight.w700),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const CustomText(text: 'Recent Commutes', fontSize: 18, fontWeight: FontWeight.w700),
                        TextButton(
                          onPressed: () {},
